return function(_, opts)
  ...
  local C = require("plugins.ui.lineUtil.env").fallback_colors
  local get_hlgroup = require("util").get_hlgroup
  local lualine_mode = require("plugins.ui.lineUtil.hl").lualine_mode
