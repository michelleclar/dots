	...
	opts = extend_tbl({
		macro_recording = {
			...
			update = {
				...
				callback = vim.fn.has("nvim-0.9") == 0 and vim.schedule_wrap(function()
...
function M.lsp(opts)
	...
	return M.builder(status_utils.setup_providers(opts, { "lsp_progress", "lsp_client_names" }, function(p_opts, p, i)
		return p_opts
				and {
					flexible = i,
