...
local custom_go_actions = require "plugins.lsp.null_ls.go"
local custom_md_hover = require "plugins.lsp.null_ls.markdown"
local sources = {
...
nls.setup {
  on_attach = require("plugins.lsp.null_ls.lsp").common_on_attach,
  debounce = 150,
