...
local join_paths = require("util").join_paths
M.opts = {
  ui = {
...
function M.get_prefix()
  ...
  return M.opts.install_root_dir or default_prefix
end
...
function M.setup()
  ...
  add_to_path(M.opts.PATH == "append")

  mason.setup(M.opts)

  if M.opts.on_config_done then
    M.opts.on_config_done(mason)
  end
end
